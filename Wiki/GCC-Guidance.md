...
To understand what your current setup is, here are the tests you should run:
...
### Check 2a - Identify your Azure configuration.
...
### Check 2b - Identify you Power Platform configuration.
...
### Check 3 - Are you running in multi-tenancy mode?
...
If you use the same domain to access the Azure portal than your O365 services, the answer is YES.
...
|-----------|---------|-----------|---------|-----------
|O365 Commercial|Azure Commercial|Yes|Yes|Standard|
|O365 Commercial|Azure Commercial|No|Yes|Standard (1)|
|O365 GCC|Azure Commercial|Yes|Yes|Standard (2)|
|O365 GCC|Azure Commercial|No|Yes|Standard (1) (2)|
|O365 GCC|Azure Government|Yes|Not Supported|Not Available (3)|
|O365 GCC|Azure Government|No|Yes|Hybrid|
...
### Your Microsoft Teams app templates is based on Power Platform resources.
